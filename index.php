...
/**
 * @package	Joomla.Site
 * @subpackage	Templates.joomla-grunt
 * @copyright	Copyright (C) 2011 - 2014 Amit Tal. All rights reserved.
...
unset($scripts['/media/system/js/modal.js']);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/js/modernizr.min.js"></script>
</head>
<body>
    <!--[if lt IE 7]>
